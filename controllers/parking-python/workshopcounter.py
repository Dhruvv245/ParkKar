...
cap = cv2.VideoCapture('D:\ParkKar\ParkKar\controllers\parking-python\workshop.mp4')

with open(r'D:\ParkKar\ParkKar\controllers\parking-python\workshopposn', 'rb') as f:
